<!DOCTYPE html>
<html lang="es">
<head><meta charset="UTF-8"><title>Reserva solicitada</title></head>
...
<body style="font-family: Georgia, serif; color: #1A0D06; max-width: 600px; margin: 0 auto; padding: 2em;">
    ...
    <p>Hemos recibido tu solicitud de reserva para el siguiente artículo:</p>
    ...
    <p>Nos pondremos en contacto contigo para confirmarla. Si tienes alguna duda puedes escribirnos a <a href="mailto:antiguedadesmortera@gmail.com" style="color: #5E3023;">antiguedadesmortera@gmail.com</a>.</p>
