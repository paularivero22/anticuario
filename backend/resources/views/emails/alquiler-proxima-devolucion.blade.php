<!DOCTYPE html>
<html lang="es">
<head><meta charset="UTF-8"><title>Recordatorio de devolución</title></head>
...
<body style="font-family: Georgia, serif; color: #1A0D06; max-width: 600px; margin: 0 auto; padding: 2em;">
    ...
    <p>Te recordamos que mañana vence el plazo de devolución de tu artículo en alquiler:</p>
    ...
    <p>Por favor devuelve el artículo antes de que venza el plazo para evitar cargos adicionales.</p>
