<!DOCTYPE html>
<html lang="es">
<head><meta charset="UTF-8"><title>Compra completada</title></head>
<body style="font-family: Georgia, serif; color: #1A0D06; max-width: 600px; margin: 0 auto; padding: 2em;">
    ...
    <p>Tu compra ha sido completada con éxito. Esperamos que disfrutes de tu nueva adquisición.</p>
    ...
    <p>Gracias por confiar en Antigüedades Mortera. Será un placer atenderte de nuevo.</p>
